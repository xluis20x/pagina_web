...
var Juego = {    
    ...
    create: function(){
        ...
        juego.physics.startSystem(Phaser.Physics.ARCADE);
            ...
            person.body.gravity.y = 1200;
            obs = juego.add.group();
            obs.enableBody = true;
            obs.createMultiple(10, 'obstaculo');
        salto = juego.input.keyboard.addKey(Phaser.Keyboard.SPACEBAR);
            salto.onDown.add(this.saltar, this);
        
        timer = juego.time.events.loop(5000, this.crearObstaculos, this);
    ...
    crearObstaculos: function(){
        ...
        for( var i = 0; i < 1; i++){
            this.crearUnObstaculo(1000, i+520);
        }
